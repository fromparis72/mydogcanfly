...
`wrangler deploy --env production` annonce `Current Version ID: 28bc972a-41bd-4acc-8d80-1abf994daee0` ;
lecture de santé après vingt secondes : `sha: 52d138fa91b2e7906887beff8464b9856d2b5681`,
`worker_version_id: 28bc972a-41bd-4acc-8d80-1abf994daee0` — **le SHA ET l'identifiant de version
concordent** avec l'annonce (règle de l'annexe 35). En ligne désormais : la fiche compagnie (annexe 40,
...
`npx wrangler deploy --env production --var BUILD_SHA:$(git rev-parse HEAD)`.
