...
/* LE LECTEUR DE ZONES A DÉMÉNAGÉ dans `test-lib/zones-publiques.mjs`, et il est réexporté ici pour
 * que les appelants existants ne changent pas. Ce n'est pas une copie : c'est le même code, et
 * c'est tout l'enjeu — le contrôle du vocabulaire IATA lit désormais les pages exactement comme
 * le contrôle des montants. */
export { zonesDe } from "./zones-publiques.mjs";
