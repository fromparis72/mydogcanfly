---
title: "Heatstroke in Dogs: How to Recognize It, Act Fast and Prevent It"
seoTitle: "Dog Heatstroke: Signs, Emergency Steps, Prevention"
description: "Heatstroke in dogs: recognize the warning signs, cool your dog safely, and prevent heat emergencies during hot summer weather."
faq:
  - q: "At what temperature should I start worrying about my dog?"
    a: "Be cautious from 25–28 °C (77–82 °F) for fragile or flat-faced dogs, and avoid any physical exertion above 28–30 °C (82–86 °F). Humidity makes things worse by preventing panting from working efficiently."
  - q: "Can I put my dog in ice-cold water if they have heatstroke?"
    a: "No. Ice-cold water makes blood vessels constrict, which slows down heat loss. Use lukewarm to cool water, wetting the belly, inner thighs and paw pads, then get to a veterinarian."
  - q: "How long can a dog stay in a car in hot weather?"
    a: "No amount of time is safe. Even with windows cracked and parked in the shade, the interior can exceed 50 °C (122 °F) in under 15 minutes. Never leave your dog alone in a vehicle in summer."
  - q: "Can heatstroke leave lasting damage?"
    a: "Yes. Even after apparent recovery, complications like kidney failure or blood-clotting disorders can develop in the following hours. A veterinary exam is essential even if your dog seems back to normal."
  - q: "How can I tell my dog is overheating before it becomes heatstroke?"
    a: "Watch for faster, louder panting than usual, actively seeking shade or cool tile floors, slowing down on walks, and heavier drooling. These are early warning signals: take a break in the shade, offer water and cool the paw pads before things escalate."
...
cover:
    image: "https://images.unsplash.com/photo-1663501258049-77f9638cbaea?ixid=M3w5ODYzMDZ8MHwxfHNlYXJjaHwxfHxkb2clMjBkcmlua2luZyUyMHdhdGVyJTIwc3VtbWVyfGVufDF8MHx8fDE3ODI0ODEyOTB8MA&ixlib=rb-4.1.0&w=1600&q=80&fm=jpg&fit=crop&crop=entropy"
    alt: "Dog cooling off in summer"
    caption: "Photo: [Isaac Guardiola](https://unsplash.com/@guardiolahtx?utm_source=mydogcanfly&utm_medium=referral) on [Unsplash](https://unsplash.com/?utm_source=mydogcanfly&utm_medium=referral)"
---

{{< meta >}}

{{< enbref >}}
- 🌡️ **Life-threatening emergency from 40.5 °C (105 °F)** rectal temperature
- 🐕 Signs: **heavy panting**, thick drool, lethargy, vomiting
- 💧 Cool with **lukewarm** water (never ice-cold): belly, thighs, paw pads
- 🚑 **Emergency vet visit**, even if your dog seems to improve
- 🚗 **Never** leave a dog alone in a car (over 50 °C / 122 °F in 15 min)
- ⏰ Walk **early morning / late evening**, never 11 a.m.–6 p.m.
{{< /enbref >}}
...
👉 **Wondering whether it's too hot right now?** Check the live heat risk where you are with our free **[Is it too hot for your dog? checker](/tools/is-it-too-hot-for-my-dog/)**.
...
A rectal temperature above **40.5 °C (105 °F)** is an **absolute emergency**. Above 43 °C (109.4 °F), organ damage often becomes irreversible: start cooling and get to a veterinarian without delay.
{{< /alerte >}}
...
1. **Use a digital thermometer** with a soft tip, kept for this purpose only and disinfected after each use.
2. **Coat the tip** with a little petroleum jelly or lubricating gel.
3. **Gently lift the tail** and insert the thermometer about 1–2 cm (0.5–1 in), without forcing, while someone reassures the dog.
4. **Wait for the beep** (5 to 60 seconds depending on the model), then read the value.
...
1. **Get the dog away from the heat source**: move them immediately into the shade or a cool, ventilated room.
2. **Cool gradually** with lukewarm to cool water (never ice-cold, which causes counterproductive vasoconstriction). Wet the belly first, then the inner thighs, armpits and paw pads.
3. **Keep air moving** with a fan or by fanning to encourage evaporation.
4. **Offer cool water** to drink in small amounts — never force it if the dog is unconscious or drowsy.
5. **Call a veterinarian immediately** and go in, even if your dog seems to be improving: internal complications (kidney failure, clotting disorders) can develop in the following hours.

To handle this kind of emergency calmly, it's best to have prepared a [dog first aid kit](/dog-first-aid-kit/) in advance, with a thermometer, gauze pads and the number of the on-call veterinarian.
...
{{< alerte type="attention" >}}
**Never use ice-cold water or ice on the skin**, and **no human medication** (acetaminophen, ibuprofen, aspirin): they are toxic to dogs.
{{< /alerte >}}
...
- **Favor cool surfaces**: grass rather than asphalt, which also burns paw pads. See our guide on [protecting your dog's paw pads](/protecting-dog-paw-pads/).
...
- [Western France Animal and Environmental Poison Control Center (CAPAE-Ouest)](https://www.centre-antipoison-animal.com)
