---
title: "Train Travel with a Dog: Rules, Tickets, and Tips"
seoTitle: "Train Travel with a Dog: Rules, Tickets & Tips"
description: "Train travel with a dog: how size, leash, muzzle and ticket rules work across operators — SNCF, Eurostar, Deutsche Bahn, Amtrak — plus tips for a calm ride."
faq:
  - q: "Does my dog need a muzzle on the train?"
    a: "It depends on the operator. Several European railways require it for larger dogs: on France's SNCF, for example, any dog over 6 kg (13 lb) traveling on a leash must wear a muzzle for the entire trip. Small dogs in a closed carrier are exempt."
  - q: "Can my dog travel free on the train?"
    a: "Guide and assistance dogs travel free on virtually every network, with documentation. For pets, it varies: in Great Britain dogs ride free (up to two per passenger, leashed), while operators like SNCF require a paid ticket for every dog, even the smallest."
  - q: "Can dogs ride Amtrak in the US?"
    a: "Yes, but only small pets: Amtrak allows dogs up to 20 lb (about 9 kg) including the carrier, in an approved carrier, on trips of 7 hours or less. Service animals travel free without those limits."
  - q: "Can I buy my dog's ticket on board?"
    a: "On some networks you can buy it from the conductor, but it's risky: certain trains limit the number of animals on board and you could be refused. It's always safer to book the pet ticket in advance with your own."
  - q: "How do I get my dog used to wearing a muzzle before the trip?"
    a: "Go gradually over 5 to 7 days: first present the muzzle with a treat inside, then hold it in place for a few seconds, and increase the duration each day. Choose a basket-style model that lets the dog pant and drink freely."
  - q: "Does my dog need vaccinations to take the train?"
    a: "For a domestic trip, proof is rarely requested in practice, but an up-to-date health record is recommended. For an international trip, rabies vaccination and the required travel documents (EU pet passport or health certificate) are mandatory."
date: 2026-06-25T16:00:00+02:00
lastmod: 2026-06-25T16:00:00+02:00
draft: false
slug: "train-travel-with-a-dog"
url: "/train-travel-with-a-dog/"
...
cover:
    image: "https://images.unsplash.com/photo-1770563181689-9609fcce408b?ixid=M3w5ODYzMDZ8MHwxfHNlYXJjaHwxfHxkb2clMjB0cmFpbiUyMHN0YXRpb24lMjB0cmF2ZWx8ZW58MXwwfHx8MTc4MjQ4MTMwMnww&ixlib=rb-4.1.0&w=1600&q=80&fm=jpg&fit=crop&crop=entropy"
    alt: "Dog at a train station before a rail trip"
    caption: "Photo: [Timur Shakerzianov](https://unsplash.com/@shaker_jpg?utm_source=mydogcanfly&utm_medium=referral) on [Unsplash](https://unsplash.com/?utm_source=mydogcanfly&utm_medium=referral)"
---

{{< meta >}}

{{< enbref >}}
- 🚆 Dogs are welcome on **most rail networks** — each operator sets its own rules
- 🐕 **Small dogs**: closed carrier on your lap or at your feet
- 🦮 **Larger dogs**: short leash, often a **muzzle** in Europe
- 🎫 A **pet ticket is usually required** — book it with yours
- 🇺🇸 **Amtrak (US)**: pets up to 20 lb (9 kg), trips of 7 hours or less
{{< /enbref >}}
...
In practice, that makes the train a real option in the US only for small dogs on short and medium hauls — for a bigger dog, a [road trip](/road-trip-with-a-dog/) is usually the way to go.
...
1. **Get your dog used to the carrier or the muzzle** several days before departure, in short, positive sessions.
2. **Tire them out** before leaving: a good walk makes for a calmer passenger.
3. **Go light on food** in the hours before departure to avoid digestive discomfort.
4. **Pack a water bottle and a collapsible bowl** to keep them hydrated on long trips.
5. **Plan a potty break** right before boarding and at connections.
6. **Bring a mat or blanket** that smells like them for reassurance.

Good organization on board also depends on the right equipment. For long trips, see our guide to [choosing the right dog travel gear](/dog-travel-gear/).
...
1. **Days 1–2**: present the muzzle without fastening it; drop a treat inside so the dog pushes their nose in voluntarily.
2. **Days 3–4**: hold it in place for a few seconds, then a few minutes, rewarding calm behavior.
3. **Days 5–7**: fasten it for increasing durations during short walks, up to 15–20 minutes without signs of discomfort.
...
Each mode has its advantages. The train avoids driving stress and keeps your dog right next to you. The car offers more freedom for stops, as explained in our guide to [traveling by car with your dog](/traveling-by-car-with-a-dog/). For long distances or international trips, flying becomes unavoidable: we detail the process in our guide to [flying with a dog](/flying-with-a-dog/). For domestic trips of a few hours, the train remains the best compromise — as long as your dog fits your operator's rules.

## Sources

- [SNCF Connect — traveling with a pet](https://www.sncf-connect.com)
- [Amtrak — pets on board](https://www.amtrak.com)
- [Service-public.fr — pets and transportation](https://www.service-public.fr)
