...
console.log("=== Étage 1 — le fait de Codex, dans la donnée à l'octet près ===");
{
  ...
  /* MOUVEMENT NOMMÉ (12–13/09/2026, vagues exhaustives suivantes) : 178 → 203. */
  check("203 politiques citées sur 302 — Air France cabine et SAS soute en font partie", citees === 203 && politiques === 302, `${citees} / ${politiques}`);
}
