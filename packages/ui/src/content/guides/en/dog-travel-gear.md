---
key: "dog-travel-gear"
title: "Choosing Dog Travel Gear: Crate, Harness, Carrier"
seoTitle: "Dog Travel Gear: Crate, Harness, Carrier Guide"
description: "Dog travel gear: how to choose a crate, safety harness or carrier based on your dog's size, your mode of transport and safety standards."
...
enbref:
  - "🎒 Gear depends on your dog's **size** and the **mode of transport**"
  - "📦 **Rigid crate**: car and plane"
  - "🔗 **Crash-tested harness**: clips to the seat belt"
  - "👜 **Carrier bag**: for **small dogs** only"
  - "🛡️ **Safety, sturdiness, comfort** matter more than price"
cover:
  image: "/travel-hub/dog-travel-gear.webp"
  alt: "A small dog pokes its head out of a travel carrier"
  credit: "Photo: [Maxim Tolchinskiy](https://unsplash.com/@shaikhulud?utm_source=mydogcanfly&utm_medium=referral) on [Unsplash](https://unsplash.com/?utm_source=mydogcanfly&utm_medium=referral)"
faq:
  ...
  - q: "Is a soft-sided crate OK for flying?"
    a: "For the cabin, some compliant soft carriers are accepted for small dogs. For the hold, however, only a rigid crate that meets the applicable requirements is allowed, because it protects the animal and withstands handling."
...
|---|---|---|---|
| Rigid crate | All sizes | Car, plane | Maximum safety, meeting the applicable requirements options |
...
- **IATA compliance** if you're flying (see our guide to [flying with a dog](/travel-hub/flying-with-a-dog/)).
...
1. **Crate length** = the dog's length (tip of nose to base of tail) **+ half the leg length**. In practice, add about 10 to 15 cm (4 to 6 in).
2. **Crate height** = the dog's standing height, ears up or top of the head, **+ 5 to 8 cm (2 to 3 in)** so they don't touch the ceiling.
3. **Width** = about twice the shoulder width, so they can turn around.
...
A harness usually goes hand in hand with gradual habituation, especially for dogs prone to stress or nausea. If your dog struggles with car rides, see our advice on [motion sickness in dogs](/travel-hub/dog-motion-sickness/).
...
1. A **collapsible bowl** and a dedicated water bottle.
2. A **mat or blanket** carrying your dog's familiar scent.
3. **Waste bags** and something to clean up with.
4. A **long line** for breaks at highway rest stops.
5. The **health kit**: vaccination record, parasite treatments, bandages.

To plan your road trips properly, see our complete guide to [traveling by car with a dog](/travel-hub/traveling-by-car-with-a-dog/).

## Sources

- [Société Centrale Canine (French Kennel Club)](https://www.centrale-canine.fr)
- [IATA — live animals transport](https://www.iata.org)
- [Service-public.fr (French public administration) — animals](https://www.service-public.fr)
- [French Road Safety Authority](https://www.securite-routiere.gouv.fr)
