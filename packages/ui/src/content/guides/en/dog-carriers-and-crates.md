...
title: "Soft Carrier or Travel Crate: Choosing the Right One for Your Dog"
seoTitle: "Dog Carrier or Crate: How to Choose"
description: "Soft carrier, crate, or kennel: how to choose based on your dog's size and travel mode, airline standards, and crate-training tips."
...
enbref:
  - "👜 **Soft carrier**: small dogs in the cabin"
  - "📦 **Approved hard crate**: car, plane, train"
  - "📐 Size = **stand up, turn around, lie down**"
  - "🐾 **Gradual habituation** makes all the difference"
cover:
  image: "/travel-hub/dog-carriers-and-crates.webp"
  alt: "a brown and white dog inside of a cage"
...
faq:
  ...
  - q: "Do I need a hard crate that meets the applicable requirements for the hold?"
...
For the car in particular, the hard crate is — along with the [dog car harness](/travel-hub/dog-car-harness/) — one of the only two genuinely reliable restraint systems.
...
If a flight is on the agenda, read our complete guide to [flying with a dog](/travel-hub/flying-with-a-dog/) before booking. For the train, the rules depend on the operator: small dogs in a carrier, large dogs on a leash, per the carrier's conditions of travel.
...
- [IATA — Live Animals Regulations (LAR) for pet transport](https://www.iata.org/en/programs/cargo/live-animals/pets/)
- [DGAC — French civil aviation authority](https://www.ecologie.gouv.fr/direction-generale-laviation-civile-dgac)
- [French Ministry of Agriculture — traveling with your pet](https://agriculture.gouv.fr/)
