...
console.log("=== 7. T0-B2 : la migration est FAITE, et la forme héritée est inconstructible ===");
{
  ...
  check("151 politiques émettent legacy_unreviewed (73 d'origine + 78 sans page à montrer)",
    porteuses === 151, String(porteuses));
...
console.log("=== 8. Baseline FIGÉE : le point de comparaison de T0-B2 est scellé ===");
{
  ...
  check("Import strict lot 7 : la baseline vivante est identique à la figée la plus récente",
    vivante.equals(readFileSync("test-baselines/import-strict-lot-7-apres.json")));
